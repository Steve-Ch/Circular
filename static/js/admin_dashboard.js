...
//                 container.style.cssText = "margin: 20px; position: relative; z-index: 9999; display: block; clear: both;";
                
//                 // BULLETPROOF TARGETING: Check every possible Jazzmin/Django container
//                 let targetDiv = document.querySelector('.content .container-fluid') // Standard Jazzmin
//                              || document.querySelector('.content') // Fallback Jazzmin
//                              || document.querySelector('.content-wrapper') // Outer Jazzmin wrapper
//                              || document.getElementById('content-main') // Standard Django
//                              || document.getElementById('content') // Older Django
//                              || document.querySelector('main') // Generic HTML5
//                              || document.body; // Absolute fallback (will put it at the very top of the site)

//                 // Inject the container at the top of whichever div it found
//                 if (targetDiv === document.body) {
//                     targetDiv.insertBefore(container, targetDiv.firstChild);
//                     console.log("Injected into: document.body (Absolute Fallback)");
//                 } else {
//                     targetDiv.prepend(container);
//                     console.log("Injected successfully into:", targetDiv.className || targetDiv.id);
//                 }
//             }

//             const today = new Date().toISOString().split('T')[0];
//             const sDate = currentStart || today;
//             const eDate = currentEnd || today;
...
//                             <div class="card-header border-0 d-flex align-items-center flex-wrap">
//                                 <h3 class="card-title mr-4 font-weight-bold"><i class="fas fa-chart-line mr-2 text-primary"></i> Platform Statistics</h3>
//                                 <div class="d-flex align-items-center flex-wrap ml-auto">
//                                     <label class="mr-2 mb-0">From:</label>
//                                     <input type="date" id="stats-start-date" class="form-control form-control-sm mr-3" style="width: auto;" value="${sDate}">
                                    
//                                     <label class="mr-2 mb-0">To:</label>
//                                     <input type="date" id="stats-end-date" class="form-control form-control-sm mr-3" style="width: auto;" value="${eDate}">
                                    
//                                     <button id="btn-update-stats" class="btn btn-sm btn-primary px-3 shadow-sm">Filter</button>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
...
//                             <div class="inner">
//                                 <h3>${data.successful_deliveries}</h3>
...
//                             <div class="inner">
//                                 <h3>₦${formattedProfit}</h3>
//                                 <p>Delivery Fee Profit</p>
//                             </div>
//                             <div class="icon">
...
// // 1. Give Jazzmin time to build the DOM structure
// setTimeout(function() {
...
//         initAdminStats();
//     }
// }, 500); // 500ms delay to ensure all Jazzmin HTML is fully rendered
